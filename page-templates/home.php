		...
		<div class="row">
			<div class="content col-12 text-center">
				...
				<div class="buttons d-flex justify-content-center align-items-center">
					...
					<a href="tel:<?php echo get_field("c5ts_phone", "option"); ?>" class="phone"><span>Call Us Now</span> <?php echo get_field("c5ts_phone", "option"); ?></a>
				</div>
			</div>
		</div>
	</div>
			...
			<dl id="accordion" class="questions mb-0" itemscope itemtype="https://schema.org/FAQPage">
				...
				<div class="card<?php echo ($i == 1) ? ' active' : ''; ?>" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
					<dt class="card-header" id="heading-<?php echo $i; ?>">
						<h3 data-toggle="collapse" data-target="#faq-<?php echo $i; ?>" aria-expanded="<?php echo ($i == 1) ? 'true' : 'false'; ?>" aria-controls="collapse-<?php echo $i; ?>" itemprop="name"><?php echo get_sub_field('question'); ?></h3>
					</dt>
