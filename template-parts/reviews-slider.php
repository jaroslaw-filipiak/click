...
<section>
    <?php if (!is_page(117) && have_rows("reviews", 117)) : ?>
        ...
        <div class="wrapper" style="background-image:url('<?php echo $theme_uri ?>/img/testimonials-bg.webp')" id="reviews" itemscope itemtype="https://schema.org/Product">
                    ...
                    <?php while (have_rows("reviews", 117)) : the_row(); ?>
                        ...
                        ?>
                            ...
                            <div class="review" itemprop="review" itemscope itemtype="https://schema.org/Review">
                                <div class="content">
                                    <img class="review__quote-icon" src="<?php echo $theme_uri ?>/img/icons/quote-icon.webp" role="presentation">
                                    ...
                                    <div class="review__footer">
                                        <div class="review__person">
                                            <div class="review__person--avatar" style="background-image:url('<?php echo esc_url($image['url']); ?>')"></div>
                                            <div>
                                        ...
                                        <div class="review__rating">
                                            <img loading="lazy" src="<?php echo $theme_uri ?>/img/icons/stars.webp" role="presentation">
                                        </div>
                                    </div>
